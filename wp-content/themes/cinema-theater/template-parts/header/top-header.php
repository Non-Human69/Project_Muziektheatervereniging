    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 text-center text-md-end align-self-center">
        <?php if( get_theme_mod( 'film_maker_lite_phone_number' ) != '') { ?>
          <span class="call-text pe-md-5 pe-2"><?php esc_html_e('CALL','cinema-theater'); ?></span><span><i class="<?php echo esc_attr(get_theme_mod('film_maker_lite_phone_icon','fas fa-phone-volume')); ?>  me-2"></i><?php echo esc_html( get_theme_mod('film_maker_lite_phone_number','')); ?></span>
        <?php } ?>
      </div>
    </div>
  </div>
