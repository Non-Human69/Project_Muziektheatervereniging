        ...
        <?php if (!is_single() && function_exists('get_post_gallery')) {
          ...
          if ($gallery && isset($gallery['ids'])) { 
            ...
            <div class="container entry-gallery">
              <div class="row">
                <?php $film_maker_lite_max_images = min(count($gallery_ids), 4);
                for ($index = 0; $index < $film_maker_lite_max_images; $index++) {
                  $id = $gallery_ids[$index];
                  $film_maker_lite_image_url = wp_get_attachment_image_url($id, 'full'); ?>
                  <div class="col-md-6 mb-1 align-self-center">
                    <img class="img-fluid" src="<?php echo esc_url($film_maker_lite_image_url); ?>" alt="Gallery Image <?php echo ($index + 1); ?>">
                  </div>
                <?php } ?>
              </div>
            </div>
