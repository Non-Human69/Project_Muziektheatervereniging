...
<?php if( get_theme_mod( 'film_maker_lite_phone_number' ) != '') { ?>
  <span class="call-text pe-5"><?php esc_html_e('CALL','film-maker-lite'); ?></span><span><i class="<?php echo esc_attr(get_theme_mod('film_maker_lite_phone_icon','fas fa-phone-volume')); ?> call-text me-2"></i><?php echo esc_html( get_theme_mod('film_maker_lite_phone_number','')); ?></span>
<?php } ?>