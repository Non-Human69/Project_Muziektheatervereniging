...
<?php $film_maker_lite_static_image = get_stylesheet_directory_uri() . '/assets/images/sliderimage.png'; ?>
          ...
          <div class="owl-carousel">
            <?php
              ...
              if($film_maker_lite_post_category){
                ...
                <div class="box">
                  <?php if(has_post_thumbnail()) { ?><?php the_post_thumbnail(); ?><?php }else {echo ('<img src="'.$film_maker_lite_static_image .'">'); } ?>
