...
if ( ! defined( 'FILM_MAKER_LITE_FREE_THEME_URL' ) ) {
	define( 'FILM_MAKER_LITE_FREE_THEME_URL', 'https://www.themespride.com/products/free-film-maker-wordpress-theme/' );
}
if ( ! defined( 'FILM_MAKER_LITE_PRO_THEME_URL' ) ) {
	define( 'FILM_MAKER_LITE_PRO_THEME_URL', 'https://www.themespride.com/products/film-maker-wordpress-theme/' );
}
if ( ! defined( 'FILM_MAKER_LITE_DEMO_THEME_URL' ) ) {
	define( 'FILM_MAKER_LITE_DEMO_THEME_URL', 'https://page.themespride.com/film-maker-pro/' );
}
if ( ! defined( 'FILM_MAKER_LITE_DOCS_THEME_URL' ) ) {
    define( 'FILM_MAKER_LITE_DOCS_THEME_URL', 'https://page.themespride.com/demo/docs/film-maker-lite/' );
}
...
if ( ! defined( 'FILM_MAKER_LITE_THEME_BUNDLE' ) ) {
    define( 'FILM_MAKER_LITE_THEME_BUNDLE', 'https://www.themespride.com/products/wordpress-theme-bundle/' );
}
...
function film_maker_lite_about_display() {
	...
	<div class="wrap about-wrap full-width-layout">
		...
		<nav class="nav-tab-wrapper wp-clearfix" aria-label="<?php esc_attr_e( 'Secondary menu', 'film-maker-lite' ); ?>">
			...
			<a href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'film-maker-lite-about', 'tab' => 'get_bundle' ), 'themes.php' ) ) ); ?>" class="blink wp-bundle nav-tab<?php echo ( isset( $_GET['tab'] ) && 'get_bundle' === $_GET['tab'] ) ?' nav-tab-active' : ''; ?>"><?php esc_html_e( 'Get WordPress Theme Bundle', 'film-maker-lite' ); ?></a>
		</nav>
	...
	?>
		<div class="feature-section two-col">
			...
			<div class="col card">
				...
				<p><a href="<?php echo esc_url( FILM_MAKER_LITE_SUPPORT_THEME_URL ); ?>" class="button button-primary"target="_blank"><?php esc_html_e( 'Support Forum', 'film-maker-lite' ); ?></a></p>
			</div>
			...
			<div class="col card">
				...
				<button class="button button-primary"><?php esc_html_e( 'GETPro20', 'film-maker-lite' ); ?></button>
			</div>
		</div>
	<?php
	}
				...
				<table>
					...
					<tbody>
						...
						<tr class="odd" scope="row">
							...
							<td class="feature feature--empty"></td>
							<td headers="comp-2" class="td-btn-2"><a class="sidebar-button single-btn" href="<?php echo esc_url( FILM_MAKER_LITE_PRO_THEME_URL );?>" target="_blank"><?php esc_html_e( 'Go for Premium', 'film-maker-lite' ); ?></a></td>
						</tr>
					</tbody>
				</table>
			</div>
...
function film_maker_lite_get_bundle() {
	if ( isset( $_GET['tab'] ) && 'get_bundle' === $_GET['tab'] ) {
	?>
		<div class="wrap about-wrap">

			<p class="about-description"><?php esc_html_e( 'Get WordPress Theme Bundle', 'film-maker-lite' ); ?></p>
			<div class="col card">
				<h2 class="title"><?php esc_html_e( ' WordPress Theme Bundle of 65+ Themes At 15% Discount. ', 'film-maker-lite' ); ?></h2>
				<p><?php esc_html_e( 'Spring Offer Is To Get WP Bundle of 65+ Themes At 15% Discount use the coupon', 'film-maker-lite' ) ?>"<input type="text" value=" TPRIDE15 "  id="myInput">".</p>
				<p><a target="_blank" href="<?php echo esc_url( FILM_MAKER_LITE_THEME_BUNDLE ); ?>" class="button button-primary"><?php esc_html_e( 'Theme Bundle', 'film-maker-lite' ); ?></a></p>
			</div>
		</div>
	<?php
	}
