...
if ( ! class_exists( 'Film_Maker_Lite_WPTT_WebFont_Loader' ) ) {
	...
	class Film_Maker_Lite_WPTT_WebFont_Loader {
		 ...
		 * @access public
		 * @since 1.0.0
		 * @return array Returns an array of remote URLs and their local film_maker_lite_counterparts.
		 */
...
if ( ! function_exists( 'wptt_get_web_film_maker_lite_font_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function wptt_get_web_film_maker_lite_font_url( $url, $format = 'woff2' ) {
		$font = new Film_Maker_Lite_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
